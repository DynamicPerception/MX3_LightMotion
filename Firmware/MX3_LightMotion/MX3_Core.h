...
const int EE_CAMMUP    = EE_MAXSHOT   + 2; // camera_mirror_up      4 
const int EE_CAMDEL    = EE_CAMMUP  + 1; // camera_delay          5
...
const int EE_CAMMUP_SS0    = EE_MAXSHOT_SS0   + 2;  // camera_mirror_up
const int EE_CAMDEL_SS0    = EE_CAMMUP_SS0  + 1;  // camera_delay
...
const int EE_CAMMUP_SS1    = EE_MAXSHOT_SS1   + 2;  // camera_mirror_up
const int EE_CAMDEL_SS1    = EE_CAMMUP_SS1  + 1;  // camera_delay
...
const int EE_CAMMUP_SS2    = EE_MAXSHOT_SS2   + 2;  // camera_mirror_up
const int EE_CAMDEL_SS2    = EE_CAMMUP_SS2  + 1;  // camera_delay
